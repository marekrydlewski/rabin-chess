...
class ChessboardLayout extends React.Component {
  ...
  componentDidMount() {
    ...
    {
      this.props.changeGame(pgnGame);
      this.props.changeTags(pgnHeaders);
    }
  }
