module.exports = {
  'View saved game' : function(browser) {
    browser
      ...
      .click('#root > div > div._3ZlvAtKLM-x2SK1Y8DVnQr > div > div > div > div > div > div > ul > li:nth-child(2) > span > span._2SC_RY3ZxUC0BwsUBhFRzR > span:nth-child(1) > button')
